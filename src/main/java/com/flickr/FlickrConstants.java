...
public interface FlickrConstants {
  ...
  public final String PHOTOSET = "photoset";
  ...
  public final String PRIMARY_PHOTO_ID = "primary_photo_id";
  public final String FLICKR_METHOD_GETPHOTOS = "flickr.photosets.getPhotos";
